''''ICS2405:Knowledge-Based Systems

mlwpy [from appendix a p. 529 - 535]
(helper) module (not a python package) for "machine learning with python for everyone"
it wraps various ML libraries/modules and provides a unified interface
'''
...
# for our purposes (writing a book with completely reproducible output)
# this *is* what we want
np.random.seed(42)

# default is [6.4, 4.8] (4:3)
mpl.rcParams['figure.figsize'] = [4.0, 3.0]
# mpl.rcParams['text.usetex'] = True  # for LaTeX support
...
#     print("Failed to set Pandas option:", e)
...
def reweight(examples, weights):
    ...
    top 2:
    1. boosting may require more precise values (or using
    randomization) to keep things unbiased
