...
{
       2,     3,     9,     4,     0,     5,     6,     0,     7,    10,
      11,    12,    13,     0,     0,    14,    16,    17,     4,     0,
       5,     6,    12,    13,     0,    15
};
...
#line 22 "3-calc.y"
                               { printf("result: %d\n\n", yyvsp[-1]); }
#line 1074 "3-calc.tab.c"
    break;

  case 4: /* program: program error '\n'  */
#line 23 "3-calc.y"
                               { yyerrok; printf("\n"); }
#line 1080 "3-calc.tab.c"
    break;

  case 6: /* expression: NUMBER  */
#line 28 "3-calc.y"
                                  { yyval = yyvsp[0]; }
#line 1086 "3-calc.tab.c"
    break;

  case 7: /* expression: expression PLUS expression  */
#line 29 "3-calc.y"
                                  { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1092 "3-calc.tab.c"
    break;

  case 8: /* expression: expression MINUS expression  */
#line 30 "3-calc.y"
                                  { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1098 "3-calc.tab.c"
    break;

  case 9: /* expression: MINUS expression  */
#line 31 "3-calc.y"
                                  { yyval = -yyvsp[0]; }
#line 1104 "3-calc.tab.c"
    break;

  case 10: /* expression: LPAREN expression RPAREN  */
#line 32 "3-calc.y"
                                  { yyval = yyvsp[-1]; }
#line 1110 "3-calc.tab.c"
    break;


#line 1114 "3-calc.tab.c"
...
void yyerror(const char *s) {
    ...
    fprintf(stderr, "Examples: 5+3, 10-2+4, -(5-3)\n");
}
