...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* program: program S '\n'  */
#line 19 "2-a_counter.y"
                        { printf("valid string! number of 'a's: %d\n\n", a_count); a_count = 0; }
#line 1067 "2-a_counter.tab.c"
    break;

  case 4: /* program: program error '\n'  */
#line 20 "2-a_counter.y"
                         { yyerrok; a_count = 0; printf("\n"); }
#line 1073 "2-a_counter.tab.c"
    break;

  case 6: /* S: A S  */
#line 25 "2-a_counter.y"
        { a_count++; }
#line 1079 "2-a_counter.tab.c"
    break;


#line 1083 "2-a_counter.tab.c"
